...
<head>
    ...
    <!-- Favicon & Icon Tab Browser Dinamis -->
...
<div class="app-layout">
    ...
    <div class="topbar-mobile" id="topbar-mobile">
        ...
        <div class="topbar-logo">
            <img src="<?php echo h(get_app_settings()['logo_sekolah'] ?? 'assets/logo_pasundan2.jpg'); ?>" alt="Logo">
        </div>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="tes_koneksi_mesin.php" class="nav-item <?php echo $active_menu === 'tes_mesin' ? 'active' : ''; ?>" onclick="closeSidebar()">
                <span class="icon-svg">
                    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="8" rx="2" ry="2"/><rect x="2" y="14" width="20" height="8" rx="2" ry="2"/><line x1="6" y1="6" x2="6.01" y2="6"/><line x1="6" y1="18" x2="6.01" y2="18"/></svg>
                </span>
                <span>Tes Koneksi Mesin</span>
            </a>
            <?php endif; ?>
            ...
            <a href="pengaturan_sekolah.php" class="nav-item <?php echo $active_menu === 'pengaturan_sekolah' ? 'active' : ''; ?>" onclick="closeSidebar()">
                <span class="icon-svg">
